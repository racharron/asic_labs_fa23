...
if {$_slk_ != "2192.8"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: 2192.8,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
if {"[string_representation [::legacy::get_attribute slack_by_mode design:gcd_coprocessor]]" != "{{mode:gcd_coprocessor/ss_100C_1v60.setup_view 2192.8}}"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack_by_mode: {{mode:gcd_coprocessor/ss_100C_1v60.setup_view 2192.8}}  current slack_by_mode: [string_representation [::legacy::get_attribute slack_by_mode design:gcd_coprocessor]]"
}
# tns
...
if {$_cell_area_ != "18461"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 18461,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "11539"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 11539,  current net area: $_net_area_"
}
unset _net_area_
