...
# Generated on: Mon Oct 23 18:46:49 PDT 2023 (Tue Oct 24 01:46:49 UTC 2023)
...
set_log_file fv/dot_product/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/dot_product -revised fv_map
...
add_notranslate_modules -library -both sram22_64x32m4w8
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  /home/cc/eecs151/fa23/class/eecs151-aeq/asic_labs_fa23/lab6/src/dot_product.v
elaborate_design -golden -root {dot_product} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/dot_product/fv_map.v.gz
elaborate_design -revised -root {dot_product}
...
#add_name_alias fv/dot_product/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/dot_product/rtl_to_fv_map.log
}
