...
gui_show_window -window ${TopLevel.1} -show_state maximized -rect {{6 61} {1925 1059}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 451} {height 738} {dock_state left} {dock_on_new_line true} {child_hier_colhier 336} {child_hier_coltype 108} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 258} {height 738} {dock_state left} {dock_on_new_line true} {child_data_colvariable 176} {child_data_colvalue 12} {child_data_coltype 61} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_sg_addsignal -group "$_session_group_2" { gcd_coprocessor_testbench.dut.op_q.deq_val gcd_coprocessor_testbench.dut.op_q.deq_data gcd_coprocessor_testbench.dut.op_q.deq_rdy }
...
catch {gui_list_select -id ${Hier.1} {gcd_coprocessor_testbench.dut.op_q}}
...
gui_list_show_data -id ${Data.1} {gcd_coprocessor_testbench.dut.op_q}
gui_show_window -window ${Data.1}
catch { gui_list_select -id ${Data.1} {gcd_coprocessor_testbench.dut.op_q.deq_val gcd_coprocessor_testbench.dut.op_q.deq_data gcd_coprocessor_testbench.dut.op_q.deq_rdy }}
...
gui_open_source -id ${Source.1}  -replace -active gcd_coprocessor_testbench.dut.op_q /home/cc/eecs151/fa23/class/eecs151-aeq/asic_labs_fa23/lab4/src/fifo.v
gui_view_scroll -id ${Source.1} -vertical -set 96
gui_src_set_reusable -id ${Source.1}

# DriverLoad 'DriverLoad.1'
gui_get_drivers -session -id ${DriverLoad.1} -signal {gcd_coprocessor_testbench.dut.op_q.deq_data[31:0]} -time 62000 -starttime 62000
